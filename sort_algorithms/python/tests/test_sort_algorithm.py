...
from python.src import bubble_sort, bubble_sort_optimized, insertion_sort
...
@pytest.mark.parametrize("sort_method", [bubble_sort, bubble_sort_optimized, insertion_sort])
